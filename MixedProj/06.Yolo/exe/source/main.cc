// code from: https://github.com/ultralytics/ultralytics/tree/main/examples/YOLOv8-CPP-Inference
...
int main() {
    ...
    try {
        ...
        std::string model_path = "yolov8l.torchscript";
        ...
        std::cout << "#  time: " << (float)duration / CLOCKS_PER_SEC << " [sek.],  w0:\n";
