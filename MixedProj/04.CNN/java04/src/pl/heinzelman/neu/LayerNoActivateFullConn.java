...
public class LayerNoActivateFullConn implements LayerParent {
    private String name;
    ...
    public LayerNoActivateFullConn(int m, int n ) { // m - number of inputs  = input  size X[m]
    ...
    private float F ( float y ){
        //float z;
        //z = z; //(float) (1.0f/(1.0f + Math.exp( -y )));
        return y;
    }
