...
if ( 1==1 )
    ...
    fileIMG=fopen( '../../01.MPL/data/train-labels-idx1-ubyte','r');
    ...
    fileIMG=fopen( '../../01.MPL/data/t10k-labels-idx1-ubyte','r');
    fileData=fread( fileIMG, 'uint8' );
    fclose(fileIMG);
    ...
    fileIMG=fopen( '../../01.MPL/data/train-images-idx3-ubyte','r');
    fileData=fread( fileIMG, 'uint8' );
    fclose(fileIMG);
    ...
    fileIMG=fopen( '../../01.MPL/data/t10k-images-idx3-ubyte','r');
    fileData=fread( fileIMG, 'uint8' );
    fclose(fileIMG);
...
% options=trainingOptions('adam', 'MaxEpochs',epochs, 'ExecutionEnvironment','gpu','ValidationPatience',10 , 'Verbose', 1 , 'MiniBatchSize', percent*100 )
options=trainingOptions('adam', 'MaxEpochs',epochs, 'ExecutionEnvironment','gpu' , 'Verbose', 1 , 'MiniBatchSize',  1024 );
