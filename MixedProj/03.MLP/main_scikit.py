...
net = snn.MLPClassifier( hidden_layer_sizes=(64,64), max_iter=100, random_state=1, alpha=0.0001,  early_stopping=False, activation='logistic', solver='sgd', learning_rate='constant', learning_rate_init=0.001 )
