...
}]},i,t,e.C_BLOCK_COMMENT_MODE,c]};return{name:"C",aliases:["h","parallelc"],keywords:u,
...
;hljs.registerLanguage("delphi",e)})();/*! `java` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("tcl",e)})();/*! `xml` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
})(); hljs.registerLanguage("xml",e)})();/*! `simscape` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=function(){"use strict";return function(e){return e.regex,{aliases:["ssc"],case_insensitive:!1,keywords:{keyword:[".elseif","case","modecharts","global","mode","definitions","catch","annotations","parameters","end","connect","component","outputs","branches",".else","modechart","modes","elseif","break","der","otherwise","else","transitions","throughs","while","components","domain","let","assert",".end","time","return","inputs","elsewhen","switch","connections","in","import","try","initial","intermediates","persistent","equations","continue","pre","when","events",".if","nodes","if","function","equation","variables","for","entry"]},contains:[{className:"string",variants:[{begin:'"',end:'"'},{begin:"'",end:"'"}]},e.COMMENT("%","$")]}}}();hljs.registerLanguage("simscape",e)})();